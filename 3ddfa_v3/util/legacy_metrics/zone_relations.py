...
def specs():
    # Historical catalogs use both names; current coverage report folds
    # relation metrics into F_zone.
    return specs_for_module(IMPLEMENTATION, families={"F_zone_rel", "F_zone"})
