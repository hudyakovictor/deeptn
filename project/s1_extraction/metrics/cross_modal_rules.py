...
class CrossModalTextureRulesV2:
    ...
    RULES = [
        ...
        },
        {
            ...
            "conditions": {
                ...
                "pore_density_r2_mpx": "< 20000",   # FIX #4: was "< 0.05" but actual values are 10000-50000
            },
            "h1_boost": 0.25,
    ...
    def _match(self, rule, geom_excess, texture, year, quality, era):
        ...
        if "pore_density_r2_mpx" in cond:
            ...
            # FIX #4: default 50000 (high value) so rule does NOT fire when metric missing
            if feature_flags.get("pore_density_r2_mpx", 50000.0) > threshold:
                return False
